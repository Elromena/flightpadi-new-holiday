...
export function DestinationSuggestion({ searchQuery, onClose }: DestinationSuggestionProps) {
    ...
    return (
      <div className="text-center py-8 px-4">
        ...
        <p className="text-white/80 mb-6">
          We're always expanding our destinations based on traveler recommendations.
        </p>
        <button
          onClick={onClose}
  ...
  return (
    <div className="max-w-lg mx-auto text-center py-8 px-4">
      ...
      <h3 className="text-xl font-semibold text-white mb-2">
        Help Us Design New Adventures
      </h3>
      <p className="text-white/80 mb-6">
        Can't find your dream destination? Tell us where you'd love to go, and we'll consider adding it to our collection.
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <textarea
            ...
            placeholder="What makes this destination special? (optional)"
